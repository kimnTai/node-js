...
var http_1 = __importDefault(require("../controller/http"));
var handle_1 = __importDefault(require("../service/handle"));
var posts_1 = __importDefault(require("../controller/posts"));
var router = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var url, method, body;
                ...
                if (url === "/posts") {
                    switch (method) {
                        case "GET":
                            ...
                            break;
                        case "POST":
                            posts_1.default.createPosts(req, res, body);
                            break;
                        case "DELETE":
                            posts_1.default.deleteAll(req, res);
                            break;
                        default:
                            handle_1.default.error(res, "無此方法");
                            break;
                    }
                    return [2 /*return*/];
                }
                if (url === null || url === void 0 ? void 0 : url.startsWith("/posts/")) {
                    switch (method) {
                        case "PATCH":
                            posts_1.default.editPosts(req, res, body);
                            break;
                        case "DELETE":
